...
## This test is long, so only run one or the other on travis, to avoid
## going over the 50 minute time limit.
if(is.na(as.integer(Sys.getenv("TRAVIS_PULL_REQUEST")))){
